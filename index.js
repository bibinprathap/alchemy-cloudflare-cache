...
async function handleRequest(event) {
  ...
  const cacheUrl = new URL('https://eth-ropsten.alchemyapi.io/v2/CBvfp4JoQkhatK3Hoxh2GCV4mTgYvJWa')
  ...
  const url = new URL('https://eth-ropsten.alchemyapi.io/v2/CBvfp4JoQkhatK3Hoxh2GCV4mTgYvJWa')
